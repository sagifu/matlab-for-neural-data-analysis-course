...
%
% Using LDA, a linear combination classification method, and NCA, a 
% supervised classification method, we classify the extracted features into
% those two classes.
%
% Script uses the following self-written functions for feature extraction
% or plot intentions (alpha-betical order).
% Description and input-output arguments are written in each function:
%     - bigBandPower 
%     - calcCoeff
%     - calcPCA
%     - calcPower
...
% set boolean variable for visualization of plots
visualize = 0;

% set boolean variable for simulation and plot
simulation = 0;
